...
## Step 3: Invoke UX Designer Skill

Before gathering requirements, read the `ux-designer` skill to frame this section around the human first.

Read the file at `.claude/skills/ux-designer/SKILL.md`. This will guide you to:
- Understand who is using this section (their emotional state, context, and goal)
- Ask questions that surface user needs, not just feature lists
- Design for flows, edge cases, empty states, and error recovery
- Apply cognitive load principles, visual hierarchy, and feedback loops to the spec

## Step 4: Gather Initial Input
...
## Step 6: Ask About Shell Configuration

If a shell design has been created for this project (check if `/src/components/shell/AppShell.vue` exists), ask the user about shell usage:
...
## Step 7: Present Draft and Refine
