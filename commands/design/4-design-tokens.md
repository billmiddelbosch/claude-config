...
## Step 3: Invoke UI Designer Skill

Before making color and typography recommendations, read the `ui-designer` skill's visual foundation guidance.

Read the file at `.claude/skills/ui-designer/SKILL.md` — specifically the **Step 1: Establish the Visual Foundation** section. Apply these principles when making suggestions:
- **60-30-10 rule** — the primary color is the 10% accent, not the dominant color; most of the interface should be neutral
- **Type scale ratios** — recommend font pairings that support a mathematical scale (1.125–1.333 ratio)
- **Neutral consistency** — never mix warm and cool gray families in the same interface
- **Maximum 3 hues** — the color choices made here constrain all future screen designs
