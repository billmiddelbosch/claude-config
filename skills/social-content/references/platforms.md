...
**Best times:** Varies — test and measure with your audience
...
- First frame of Reels must hook immediately
- Carousels: up to 10 slides with educational content
- Use all Story features (polls, links, stickers)
...
**What doesn't:**
- Overly produced, polished content
- Ignoring trends
- Hard selling
- Repurposed horizontal video

**Format tips:**
- Hook in first 1–2 seconds (non-negotiable)
...
- Ignoring comments
- Cross-posting from other platforms without adapting

---

## Scheduling: When to Schedule vs. Post Live

**Schedule:** Core content posts, threads, carousels, evergreen content

**Post live:** Real-time commentary, responses to news/trends, engagement with others, anything requiring immediate interaction
